...
**HTTP & workflow:** `send_http1_request`, `send_http2_request`, `send_and_open_repeater`, `resend_history_entry`, `create_repeater_tab`, `create_repeater_tab_http2`, `send_to_intruder`, `extract_parameters`, `list_repeater_tabs`, `get_repeater_tab`, `close_repeater_tab`
